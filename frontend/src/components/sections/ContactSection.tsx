...
const ContactSection = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: 'Phone Number',
      content: <><a href="tel:0722446473" className="text-medical-700 font-semibold hover:underline">Emergency: 0722446473</a><br /><a href="tel:+254722446473" className="hover:underline">Office: +254 722 446 473</a></>,
    },
    {
      icon: Mail,
      title: 'Email Address',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 reveal-animation">
            <div className="glass-card rounded-2xl overflow-hidden">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15955.277444357746!2d36.78970983385497!3d-1.2581182536087992!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f173c0a1d9b15%3A0xece6d99c6f599ee0!2sWestlands%2C%20Nairobi!5e0!3m2!1sen!2ske!4v1692653194954!5m2!1sen!2ske" 
                width="100%" 
                height="250" 
                style={{ border: 0 }} 
                allowFullScreen 
